  ...
  e(".as-carousel").each((function () {
    ...
    e("[data-slick-next]").each((function () {
      ...
      s.slick({
        ...
        vertical: !!t("vertical"),
        prevArrow: t("prev-arrow") ? o : '<button type="button" class="slick-prev"><i class="far fa-long-arrow-left"></i></button>',
        nextArrow: t("next-arrow") ? r : '<button type="button" class="slick-next"><i class="far fa-long-arrow-right"></i></button>',
